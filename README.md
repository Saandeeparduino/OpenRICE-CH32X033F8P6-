...
<p align="center">
  <img width="250" height="350" alt="OpenRISC V2 board preview" src="https://github.com/user-attachments/assets/5828ecea-6f87-4235-821f-15c5ce70c123" />
  &nbsp;&nbsp;
  <img width="525" height="375" alt="OpenRISC V2 board preview - full view" src="https://github.com/user-attachments/assets/894d95db-362d-4fcf-b62b-df4829a2b5ff" />
</p>
---
...
This project also serves as a hands-on learning platform for **student interns at Vishishta Innovators**, giving them real-world exposure to hardware design, firmware development, and embedded systems engineering.

### 🎓 Student Interns Personally Involved
...
## 🔮 Coming Soon: OpenRISC V2

We're already working on **OpenRISC V2** — an improved successor to V1 with a better development and debugging experience.

**What's new in V2:**

- 🐞 **Onboard serial debugger** for easier real-time debugging
- 🔀 **Selection switch** to toggle between **Programming Mode** and **Serial Debugger Mode**
- 🔌 Powered by the **CH340N** USB-to-serial chip

> V2 is designed to be a more capable, developer-friendly upgrade over V1 — stay tuned for updates!
...
```cpp
void setup() {
  pinMode(PA6, OUTPUT);  // PA6 is for Onboard Led
}
